...
using optional_dremel_view = std::optional<detail::dremel_device_view const>;
...
// std::optional<dremel_device_view> at the element_comparator level (which
...
// std::optional<dremel_device_view> member must be an optional rather than
